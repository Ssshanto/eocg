# -*- coding: utf-8 -*-
"""Transformation_Translation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kUwE9jue2k_-s696GBIKLybuQxCWdTdm
"""
...
#       text=Text("Transformation", font_size=40)
#       self.play(text.animate.to_edge(UP))
#       text2=Text("Translation", font_size=25, color=BLUE)
#       self.play(text2.animate.shift(UP*2.5))
#       c.scale(.45)
#       c.shift(ORIGIN)
#       self.play(Create(c))
#       self.play(c.animate.shift(RIGHT*2))
#       self.play(c.animate.shift(LEFT*4))
#       self.wait(2)
...
#       self.play(Create(cp))
#       self.wait(3)
#       self.play(number_plane.animate.shift(RIGHT*3))
#       self.wait(2)
#       text4=Text("For every transformation\nThe coordinate system updates itself according to your translation!",font_size=20, color=WHITE)
...
#       self.wait(3)
#       tt=Text("But here is a problem!", font_size=25, color=BLUE)
#       bbb=SurroundingRectangle(tt, color=YELLOW,buff=MED_LARGE_BUFF)
#       ggg=VGroup(bbb,tt)
#       ggg.shift(np.array([-2,1.5,0]))
#       self.play(Create(ggg), run_time=4)
#       self.wait(2)
#       self.play(ggg.animate.to_edge(UP))
#       self.wait(2)
#       
#       
#       self.remove(ggg)
#       self.wait(2)
#       
#       ff=Text("Translation of 2x2!", font_size=25)
...
#       self.add(g)
# 
#       fff=Text("Final Product!", font_size=25)
...
#       self.add(m0)
#       text6=Text("Linear Transformation leaves origin invariant\nSo translation is not possible in 2x2 matrix.\nSolution? Add an Extra dimension!", font_size=20, color=BLUE)
...
#       self.wait(3)
# 
#       #self.remove(g,ff,fff,m0)
# 
#       text7=Text("Affine Transformation!\nUsed for Translation by adding an extra dimension", font_size=25, color=BLUE)
#       box7 = SurroundingRectangle(text6, color=YELLOW, buff=MED_LARGE_BUFF)
#       
#       text7.shift(np.array([-1,-2,0]))
#       self.play(Write(text7), run_time=4)
#       self.wait(3)
#       self.remove(gpx,text7)
#       self.remove(g,ff,fff,m0)
# 
# 
# 
...
#       var = 0.5
#       on_screen_var = Variable(var, Text("Update Value of Y"), num_decimal_places=3)
# 
#       # You can also change the colours for the label and value
#       on_screen_var.label.set_color(RED)
#       on_screen_var.value.set_color(GREEN)
#       on_screen_var.scale(.75)
#       on_screen_var.shift(np.array([-2.25,-1,0]))
# 
...
#           int_var, Text("Update Value of X"), num_decimal_places=3
...
#       self.wait(2)
#       self.play(var_tracker.animate.set_value(var),cpp.animate.shift(LEFT*2), run_time=4)
#       self.wait(3)
#       self.play(var_tracker1.animate.set_value(var),cpp.animate.shift(DOWN*2), run_time=4)
#       self.wait(3)
...
#       #self.remove(g,ff,fff,m0)
# 
#       text7=Text("Affine Transformation! Used for Translation by adding an extra dimension", font_size=25, color=BLUE)
#       box7 = SurroundingRectangle(text6, color=YELLOW, buff=MED_LARGE_BUFF)
#       
#       text7.shift(np.array([-2,-3,0]))
#       self.play(Write(text7), run_time=4)
#       self.wait(3)
#       self.remove(gpx,text7)
#       self.remove(g,ff,fff,m0)
