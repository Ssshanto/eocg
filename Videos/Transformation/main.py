...
class transformer(Scene):
    ...
    def construct(self):
        s = Casper()
        s.scale(.5)
        ttext = Tex("Translation")
        ttext.shift(LEFT*6, RIGHT*7, UP*3)
        ...
        ttext.shift(LEFT*6, RIGHT*7, UP*3)
        self.play(Write(ttext))
        self.play(Rotate(s, angle=PI, about_point=ORIGIN, run_time=3))
        self.wait(4)
        self.remove(ttext)
        self.play(Uncreate(s))
        self.wait(2)
        st = Tex("Old Coordinate: x, y", font_size=25)
        st.shift(UP*2, LEFT*3)
        self.play(Write(st))
        st2 = Tex("New Coordinate: x', y'", font_size=25)
        ...
        self.play(Write(st2))
        st3 = Tex(
            "In That Case:\n\nX= x cos θ - y sin θ\n\nY=x sin θ + y cos θ", font_size=25)
        st3.shift(UP*-2, LEFT*3)
        ...
        self.wait(3)
        tr = Tex("Translation", font_size=35)
        self.play(Write(tr))
        cross = Cross()
        cross.shift(DOWN*2)
        self.add(cross)
        ...
        self.wait(3)
        affine = Tex("Homogenuse Coordinates", font_size=35)
        self.play(Write(affine))
        self.wait(3)
        affine1 = Tex("1.Helps in Matrix Composition", font_size=25)
        ...
        self.wait(3)
        st = Tex("Old Coordinate: x, y", font_size=20)
        st.shift(UP*2, LEFT*3)
        self.play(Write(st))
        st2 = Tex("New Coordinate: x', y'", font_size=20)
        st2.shift(UP*1, LEFT*3)
        self.play(Write(st2))
        st3 = Tex("In That Case:\n\nx'= Tx + x\n\ny'=Ty + y", font_size=25)
        st3.shift(UP*-2, LEFT*3)
